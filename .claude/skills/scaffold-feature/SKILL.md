...
description: Scaffold a new Flutter feature screen with cubit, state, model, and repository files following HoosierCiv architecture conventions. Use when adding a new screen or feature to the app.
