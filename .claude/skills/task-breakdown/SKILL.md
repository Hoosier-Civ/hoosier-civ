---
name: task-breakdown
description: Break a planned feature into concrete tasks, get user approval, then create a parent GitHub issue with sub-issues — including milestone, label, and issue type. Run this after /plan-feature.
