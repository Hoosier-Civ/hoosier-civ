...
description: Review an existing API service file for errors, missing endpoints, or security issues — or scaffold a new service for HoosierCiv. Use when working with civic data APIs or adding a new external integration.
argument-hint: "[service-file.dart or new-api-description]"
