---
name: generate-bill-content
description: Use the Claude API to generate a plain-language summary, quiz, legislator talking points, and news digest prompt for a specific Indiana bill. Use when seeding bill content or testing the content pipeline.
argument-hint: "[bill-number or bill-text]"
...
Generate the following content using the Claude API (claude-haiku-4-5 model):
