...
export function determineChamber(officeName: string): string | null {
...
/**
 * Minimal interface covering the Supabase operations this function needs.
 * Typed loosely so tests can supply a simple mock without pulling in the full client.
 */
