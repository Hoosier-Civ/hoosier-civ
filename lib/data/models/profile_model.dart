/// A private sentinel used by [ProfileModel.copyWith] to distinguish
/// "caller did not supply a value" from "caller explicitly passed null".
class _Sentinel {
  const _Sentinel();
}
...
class ProfileModel {
  ...
  ProfileModel copyWith({
    ...
    return ProfileModel(
      ...
      zipCode: identical(zipCode, _sentinel)
          ? this.zipCode
          : zipCode as String?,
